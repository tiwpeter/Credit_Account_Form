...
public class ReportService
{
    public void RegisterCustomerReportData(Report report, GetCustomersDTO customer)
    {
        ...
        {
            var generalList = new List<GeneralModel> { customer.General };
            ...
            {
                var addressList = new List<AddressModel> { customer.General.Address };
        ...
        {
            var shippingList = new List<ShippingModel> { customer.Shipping };
            ...
            {
                var shipCountryList = new List<CountryModel> { customer.Shipping.Country };
            ...
            {
                var shipProvinceList = new List<ProvinceModel> { customer.Shipping.Province };
        ...
        {
            report.RegisterData(new List<CustomerSignModel> { customer.CustomerSign }, "CustomerSignData");
